	  		...
	  		<div class="item">
      			<table width="200px" height="300px" cellspacing="0" cellpadding="1">
 		 			<tr>
  					  ...
  					  <img src = "/1118/debut/watches/${watch.watchImage }" width = "250px" height = "250px"
  					   onmouseover="this.src='watches/${watch.watchImage1}'" onmouseout="this.src='/1118/debut/watches/${watch.watchImage}'"/></a></td>
  					</tr>
  					<tr>
  					  <td class = "watchName">
...
<c:set var = "height" value="${(fn:length(list)/3)*350+140 }"/>
</c:if>
<c:if test="${fn:length(list)%3 eq 1 }">
<c:set var = "height" value="${(fn:length(list)/3)*350+140+350 }"/>
</c:if>
