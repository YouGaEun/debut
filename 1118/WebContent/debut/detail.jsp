...
<c:set var = "price" value = "${watch.price }"/>
  ...
  <tr>
    ...
    <td class = "content watchStyle"><c:forEach var = "styles" items = "${watch.watchStyle }"><a href = "selectStyle.jsp?watchStyle=${styles }" style = "background-color:#FFCCFF; color :#000"># ${styles }</a>    </c:forEach></td>
  </tr>
  <tr>
    <td>옵션</td>
    <td class = "content">
