...
<div id = "page_center" style = "height:auto;"><!-- page_center -->
...
<h3 style = "color: #810B0C; margin-top:50px">상품 관리</h3>
  ...
  <c:forEach var = "watch" items = "${list }">
        <tr>
    		...
    		<td class = "content"><img src="/1118/debut/watches/${watch.watchImage }" width="50" height="50" /></td>
   ...
   <tr>  
        <td colspan="7" class = "menu"><br/>
            ...
            <select name="keyField"><!-- 검색할 분야? -->
                ...
                <option value="watchName">시계품명</option>
...
<c:set var = "height" value="${(fn:length(list))*65+140 }"/>
<!--page_footer영역-->
