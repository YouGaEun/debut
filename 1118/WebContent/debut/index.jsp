	  	  ...
	  	  <c:if test="${list != null }">
      			...
      			<table width="200px" height="300px" cellspacing="0" cellpadding="1">
 		 			<tr>
  					  ...
  					  <img src = "watches/${watch.watchImage }" width = "250px" height = "250px"
    ...
    <%
	  ...
	  <c:set var = "list" value = "<%=watchs %>"/>
	  	...
	  	<c:if test="${fn:length(list) eq 0 }">
	  		<%
	  			Connection conn1 = ConnectionProvider.getConnection();//1. 커넥션을 만ㄷ름
	  			List<Watch> watchs1 = null;//4. 저장할 배열 선언하기
	  			try{//2. try catch문 만듦
	  				WatchDao wDao = new WatchDao();//3. dao객체 생성
	  				watchs1 = wDao.selectListNew(conn1);//4. watchs에 저장
	  			}catch(SQLException e){}
	  
	  %>
	  <c:set var = "list1" value = "<%=watchs1 %>"/>
	  	<hr/>
	  		<h3>인기상품 TOP3</h3> 
	  	<hr/>
	  	<c:forEach var = "watch" items = "${list1 }">
	  	  <c:if test="${list != null }">
	  			 <div class="item">
      			<table width="200px" height="300px" cellspacing="0" cellpadding="1">
 		 			<tr>
	  	  ...
	  	  <c:if test="${list != null }">
      			...
      			<table width="200px" height="300px" cellspacing="0" cellpadding="1">
 		 			<tr>
  					  ...
  					  <a href = "/1118/debut/detail.jsp?watchId=${watch.watchId }">
  					  <img src = "watches/${watch.watchImage }"  width = "250px" height = "250px"
  					   onmouseover="this.src='/1118/debut/watches/${watch.watchImage1}'" onmouseout="this.src='watches/${watch.watchImage}'"/></a></td>
  					</tr>
  					<tr>
  					  <td class = "watchName">
  					  <a  style="color: #555" href = "detail.jsp?watchId=${watch.watchId }">
